...
fn test_no_conversion() {
    ...
    assert_eq!(converted.next_sample(), NextSample::Sample(0));
    assert_eq!(converted.next_sample(), NextSample::Sample(0));
    assert_eq!(converted.next_sample(), NextSample::Sample(1));
    assert_eq!(converted.next_sample(), NextSample::Sample(1));
    assert_eq!(converted.next_sample(), NextSample::Sample(2));
    assert_eq!(converted.next_sample(), NextSample::Sample(2));
    converted.inner_mut().set_paused(true);
    assert_eq!(converted.next_sample(), NextSample::Paused);
    assert_eq!(converted.next_sample(), NextSample::Paused);
    converted.inner_mut().set_paused(false);
    assert_eq!(converted.next_sample(), NextSample::Sample(3));
    assert_eq!(converted.next_sample(), NextSample::Sample(3));
}
...
fn test_four_times() {
    ...
    assert_eq!(converted.next_sample(), NextSample::Sample(0));
    assert_eq!(converted.next_sample(), NextSample::Sample(0));
    assert_eq!(converted.next_sample(), NextSample::Sample(4));
    assert_eq!(converted.next_sample(), NextSample::Sample(4));
    assert_eq!(converted.next_sample(), NextSample::Sample(8));
    converted.inner_mut().set_paused(true);
    ...
    // a different offset
    assert_eq!(converted.next_sample(), NextSample::Sample(10));
    assert_eq!(converted.next_sample(), NextSample::Sample(10));
    assert_eq!(converted.next_sample(), NextSample::Sample(14));
    assert_eq!(converted.next_sample(), NextSample::Sample(14));
}
...
fn test_div_4() {
    ...
    assert_eq!(converted.next_sample(), NextSample::Sample(4));
    assert_eq!(converted.next_sample(), NextSample::Sample(4));
    assert_eq!(converted.next_sample(), NextSample::Sample(5));
}
...
fn catch_metadata_changed_when_passing_through() {
    ...
    assert_eq!(converted.next_sample(), NextSample::MetadataChanged);
    assert_eq!(converted.sample_rate(), 1000);
    assert_eq!(converted.inner_mut().sample_rate(), 2000);
    assert_eq!(converted.next_sample(), NextSample::Sample(2));
    assert_eq!(converted.next_sample(), NextSample::Sample(4));
    assert_eq!(converted.next_sample(), NextSample::Sample(6));
    assert_eq!(converted.channel_count(), 1);
}
