...
fn empty_gives_metadata_changed_on_next() {
    ...
    assert_eq!(list.next_sample(), NextSample::Finished);
    ...
    assert_eq!(list.next_sample(), NextSample::MetadataChanged);
    assert_eq!(list.channel_count(), 4);
    assert_eq!(list.sample_rate(), 1000);
    assert_eq!(list.next_sample(), NextSample::Sample(1));
    assert_eq!(list.next_sample(), NextSample::Sample(2));
    assert_eq!(list.next_sample(), NextSample::Sample(3));
    assert_eq!(list.next_sample(), NextSample::Sample(4));
    assert_eq!(list.next_sample(), NextSample::MetadataChanged);
    assert_eq!(list.channel_count(), 2);
    assert_eq!(list.sample_rate(), 8000);
    assert_eq!(list.next_sample(), NextSample::Sample(5));
    assert_eq!(list.next_sample(), NextSample::Sample(6));
    assert_eq!(list.next_sample(), NextSample::Finished);
}
